 ...
 * @author INTEL
 */
public class UserM extends javax.swing.JFrame {
...
ResultSet rs = null;
    ...
    public void table () {
        ...
        DefaultTableModel table = new DefaultTableModel();
                ...
                try{
                    ...
                    String sql ="SELECT studentid, lastname, firstname, year, section, vote_count FROM user ORDER BY lastname, year ASC" ;
    ...
    private void initComponents() {
        ...
        aa.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "SURNAME", "FIRST NAME", "MIDDLE NAME", "ID NUM", "AGE", "GENDER"
            }
        ));
        aa.setSelectionBackground(new java.awt.Color(204, 255, 255));
        aa.setSelectionForeground(new java.awt.Color(0, 0, 0));
...
int row = aa.getSelectedRow();
String cell =  aa.getModel().getValueAt(row, 0).toString();
String sql = "DELETE FROM user WHERE studentid = " + cell;
try {
    pst = conn.prepareStatement(sql);
    pst.execute();
   ...
   table();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UserM.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
