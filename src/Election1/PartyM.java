 ...
 * @author INTEL
 */
public class PartyM extends javax.swing.JFrame {
   ...
   public void tablePa () {
        ...
        DefaultTableModel table = new DefaultTableModel();
                ...
                try{
                    ...
                    String sql ="SELECT num, name FROM party ORDER BY num ASC" ;
    ...
    private void initComponents() {
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon("C:\\Users\\INTEL\\Downloads\\1PICS\\position1.png")); // NOI18N
        ...
        party.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null},
                {null},
                {null},
        ...
        party.setSelectionBackground(new java.awt.Color(204, 255, 255));
        party.setSelectionForeground(new java.awt.Color(0, 0, 0));
        jScrollPane1.setViewportView(party);
...
int row = party.getSelectedRow();
String cell =  party.getModel().getValueAt(row, 0).toString();
String sql = "DELETE FROM party WHERE num = " + cell;
try {
    pst = conn.prepareStatement(sql);
    pst.execute();
   ...
   tablePa();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PartyM.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTable party;
