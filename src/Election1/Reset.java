...
try {
    ...
    private void initComponents() {
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon("C:\\Users\\INTEL\\Downloads\\1PICS\\reset1.png")); // NOI18N
        ...
        jPanel15.setBackground(new java.awt.Color(237, 237, 237));
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon("C:\\Users\\INTEL\\Downloads\\1PICS\\about-us.png")); // NOI18N
        ...
        jLabel21.setIcon(new javax.swing.ImageIcon("C:\\Users\\INTEL\\Downloads\\1PICS\\candidate.png")); // NOI18N
        ...
        jLabel17.setIcon(new javax.swing.ImageIcon("C:\\Users\\INTEL\\Downloads\\1PICS\\party.png")); // NOI18N
        ...
        jLabel16.setIcon(new javax.swing.ImageIcon("C:\\Users\\INTEL\\Downloads\\1PICS\\user (1).png")); // NOI18N
...
int des = JOptionPane.showConfirmDialog(null, "Are you sure you want to reset all of data?","Confirmation",JOptionPane.YES_NO_OPTION,JOptionPane.QUESTION_MESSAGE);  
    if (des ==0){
    String sql = "DELETE FROM user";
try {
    pst = conn.prepareStatement(sql);
    pst.execute();
   JOptionPane.showMessageDialog(null, "Voters has been reset successfully.");  
...
int des = JOptionPane.showConfirmDialog(null, "Are you sure you want to reset all of data?","Confirmation",JOptionPane.YES_NO_OPTION,JOptionPane.QUESTION_MESSAGE);  
    if (des ==0){
    String sql = "DELETE FROM candidates_info";
    user();
try {
    pst = conn.prepareStatement(sql);
    pst.execute();
   JOptionPane.showMessageDialog(null, "Candidates has been reset successfully.");  
  new Reset().setVisible(true);
...
try {
    pst = conn.prepareStatement(sql);
    pst.execute();
   JOptionPane.showMessageDialog(null, "Party has been reset successfully.");  
  new Reset().setVisible(true);
...
try {
    pst = conn.prepareStatement(sql);
    pst.execute();
   JOptionPane.showMessageDialog(null, "Admin has been reset successfully.");  
  new Reset().setVisible(true);
