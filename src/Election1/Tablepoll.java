...
public class Tablepoll extends javax.swing.JFrame {
...
ResultSet rs = null;
    ...
    public void tableP () {
        ...
        DefaultTableModel table = new DefaultTableModel();
                ...
                table.addColumn("VOTE COUNT");
                
                try{
                    conn = Database.ConnectDatabase();
                    String sql ="SELECT fullname, vote_count FROM candidates_info WHERE position = 'PRESIDENT' ORDER BY vote_count DESC" ;
    ...
    public void tableVP () {
        ...
        DefaultTableModel table = new DefaultTableModel();
                ...
                try{
                    conn = Database.ConnectDatabase();
                    String sql ="SELECT fullname, vote_count FROM candidates_info WHERE position = 'VICE-PRESIDENT' ORDER BY vote_count DESC" ;
                    pst = conn.prepareStatement(sql);
                    rs = pst.executeQuery();
    ...
    public void tableSEC () {
        ...
        DefaultTableModel table = new DefaultTableModel();
                ...
                try{
                    conn = Database.ConnectDatabase();
                    String sql ="SELECT fullname, vote_count FROM candidates_info WHERE position = 'SECRETARY' ORDER BY vote_count DESC" ;
                    pst = conn.prepareStatement(sql);
                    rs = pst.executeQuery();
    ...
    public void tableASEC () {
        ...
        DefaultTableModel table = new DefaultTableModel();
                ...
                try{
                    conn = Database.ConnectDatabase();
                    String sql ="SELECT fullname, vote_count FROM candidates_info WHERE position = 'ASSISTANT SECRETARY' ORDER BY vote_count DESC" ;
                    pst = conn.prepareStatement(sql);
                    rs = pst.executeQuery();
    ...
    public void tableTRES () {
        ...
        DefaultTableModel table = new DefaultTableModel();
                ...
                try{
                    conn = Database.ConnectDatabase();
                    String sql ="SELECT fullname, vote_count FROM candidates_info WHERE position = 'TREASURER' ORDER BY vote_count DESC" ;
                    pst = conn.prepareStatement(sql);
                    rs = pst.executeQuery();
    ...
    public void tableAU () {
        ...
        DefaultTableModel table = new DefaultTableModel();
                ...
                try{
                    conn = Database.ConnectDatabase();
                    String sql ="SELECT fullname, vote_count FROM candidates_info WHERE position = 'AUDITOR' ORDER BY vote_count DESC" ;
                    pst = conn.prepareStatement(sql);
                    rs = pst.executeQuery();
     ...
     public void total () {
                ...
                try{
                    conn = Database.ConnectDatabase();
                    String sql ="SELECT sum(vote_count) as sum FROM candidates_info WHERE position = 'PRESIDENT'" ;
                    pst = conn.prepareStatement(sql);
                    rs = pst.executeQuery();
                    
                    while (rs.next()){
                       
                  jLabel17.setText(rs.getString("sum"));
    ...
    private void initComponents() {
        ...
        jLabel13.setText("VOTING RESULTS");
        jLabel13.setToolTipText("");

        jLabel5.setIcon(new javax.swing.ImageIcon("C:\\Users\\INTEL\\Downloads\\1PICS\\USERV.png")); // NOI18N
        ...
        jPanel14.setForeground(new java.awt.Color(237, 237, 237));
        ...
        jPanel18.setForeground(new java.awt.Color(237, 237, 237));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tablepoll.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
